...
public class Login extends JFrame implements ActionListener
{
	...
	Login(){
		...
		JLabel heading= new JLabel("Simple Minds");   //heading of the frame
		heading.setBounds(800,15,400,45);
		heading.setFont(new Font("Viner Hand ITC",Font.BOLD,28));   // set Font and size
		...
		rule = new JButton("Rules");			//Rules Button
